...
export default function VendorsSection() {
        ...
        () => [
            ...
            },
            {
                ...
                render: (_, row) => {
                    ...
                    return (
                        <span
                            className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium capitalize ${colors[status] || "bg-slate-100 text-slate-700 border border-slate-200"
                                }`}
                        >
                            {status}
                        </span>
            ...
            },
            {
                ...
                accessor: "vendorProfile",
                render: (_, row) => {
                    const permissions = row.vendorProfile?.permissions || [];
                    const count = permissions.filter((p) => p.granted).length;
                ...
                render: (_, row: any) => {
                    ...
                    return (
                        <DotMenu
                            ...
                            onResetPassword={() => handleResetPassword(row._id)}
    ...
    // Handle reject confirm with reason
    ...
    const handleResetPassword = (id: string) => {
        dispatch(resetVendorPassword(id));
    };
                    ...
                    <div className="w-full max-w-md rounded-2xl bg-white p-6 shadow-xl">
                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    className="w-full rounded-lg border border-slate-200 px-4 py-2.5 text-sm outline-none transition focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 resize-none"
                                    autoFocus
                                />
                                {!rejectReason.trim() && (
                                    <p className="mt-1 text-xs text-red-500">Please provide a reason</p>
                                )}
                            </div>
                        </div>
                        ...
                        <div className="flex justify-end gap-3 mt-6 pt-4 border-t border-slate-200">
                            <Button
                                ...
                                className="px-4 h-9 rounded-lg border border-slate-200 bg-white text-sm font-medium hover:bg-slate-50"
                            >
                                Cancel
                            </Button>
                            <Button
                                ...
                                className="flex items-center gap-2 px-4 h-9 rounded-lg bg-red-600 text-white text-sm font-medium hover:bg-red-700 disabled:opacity-60 disabled:cursor-not-allowed"
                            >
                                {isSubmittingReject ? (
                                    <>
